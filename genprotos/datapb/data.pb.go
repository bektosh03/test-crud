...
func (x *CollectPostsRequest) Reset() {
	*x = CollectPostsRequest{}
...
func (x *CollectPostsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CollectPostsRequest) ProtoMessage() {}

func (x *CollectPostsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protos_datapb_data_proto_msgTypes[0]
...
// Deprecated: Use CollectPostsRequest.ProtoReflect.Descriptor instead.
...
var file_protos_datapb_data_proto_rawDesc = []byte{
	...
	0x64, 0x62, 0x22, 0x15, 0x0a, 0x13, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x50, 0x6f, 0x73,
	0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x65, 0x6b, 0x74, 0x6f, 0x73, 0x68, 0x30,
	0x33, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x2d, 0x63, 0x72, 0x75, 0x64, 0x2f, 0x67, 0x65, 0x6e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_protos_datapb_data_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_protos_datapb_data_proto_goTypes = []interface{}{
	(*CollectPostsRequest)(nil), // 0: datadb.CollectPostsRequest
}
...
func file_protos_datapb_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_datapb_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CollectPostsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
